            ...
            <Row className="justify-content-center">
              <Col lg={8}>
                <div className="text-center pt-0 ">
                  <h1 className="text-heading mt-3 services-heading">
                    Our Team
                  </h1>
                  <p className="text-muted mb-4">
                    We are highly dedicated to providing quality education
                    through practical methods. We believe in nurturing students
                    through their formative years to shape their futures.
                  </p>
                </div>
              </Col>
            </Row>
